...
/* #undef HAVE_SYSTEMCONFIGURATION_FRAMEWORK */
...
#define PACKAGE_BUILD "x86_64-unknown-linux-gnu"

/* Define to the hostname of the host who builds the package. */
#define PACKAGE_BUILD_HOSTNAME "droid02-bj"

/* Define to the command line used to invoke the configure script. */
#define PACKAGE_CONFIGURE_INVOCATION "./configure "

/* Define to the canonical host-system name */
#define PACKAGE_HOST "x86_64-unknown-linux-gnu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "miredo"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "miredo 1.2.4"
